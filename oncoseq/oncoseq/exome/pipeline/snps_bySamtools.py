...
def call_snps(ref_fa, tumor_bam_file, bcf_file, vcf_file):
    ...
    args = ["samtools", "mpileup", "-DSuf",ref_fa, tumor_bam_file]
...
def main():
    ...
    return call_snps(args.ref_fa, args.tumor_bam_file, args.bcf_file, args.vcf_file)
