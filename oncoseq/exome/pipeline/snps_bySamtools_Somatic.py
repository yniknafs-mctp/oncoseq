...
def call_snps(ref_fa, normal_bam_file, tumor_bam_file, bcf_file, vcf_file):
    ...
    args = ["samtools", "mpileup", "-DSuf",ref_fa, tumor_bam_file,normal_bam_file]
    mpileup_p = subprocess.Popen(args, stdout=subprocess.PIPE)
    args = ["bcftools", "view", "-bvcgT","pair", "-"]
...
def main():
    ...
    return call_snps(args.ref_fa, args.normal_bam_file, args.tumor_bam_file, args.bcf_file, args.vcf_file)
